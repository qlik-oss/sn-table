...
export default function ext(env) {
  return {
    ...
    importViewDataProperties(exportFormat, initialProperties, extension, hypercubePath) {
      return importViewDataProperties({ exportFormat, initialProperties, extension, hypercubePath });
    },
