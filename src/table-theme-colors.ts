...
export default function tableThemeColors(theme: UseTheme, rootElement: HTMLElement) {
  ...
  const sheetBackgroundColorFromCSS =
    (qvPanelSheet && window.getComputedStyle(qvPanelSheet).backgroundColor) ?? undefined;
