...
export const isBodyWidthLessThenContainerWidth = (columnWidths: number[], tableWidth: number) =>
  columnWidths && columnWidths.length > 0 ? columnWidths.reduce((a, b) => a + b) < tableWidth : false;
